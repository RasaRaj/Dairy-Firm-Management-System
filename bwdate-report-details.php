...
<li class="breadcrumb-item active" aria-current="page">Item Report Details</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
...
?>
    ...
    <span class="feather-icon"><i data-feather="database"></i></span></span>Item Report Details From<?php echo $fdate?> to <?php echo $tdate?></h4>
                </div>
                <!-- /Title -->
