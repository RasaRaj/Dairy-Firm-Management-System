...
<div class="invalid-feedback">Please valid product name.</div>
</div>
</div>
...
<section class="hk-sec-wrapper">
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <div class="table-wrap">
<h4>Sales Calculations</h4>
<hr />

<a id="btnEmpty" href="search-product.php?action=empty" >Empty</a>
<?php
...
<div class="invalid-feedback">Please valid customer name.</div>
</div>
<div class="col-md-6 mb-10">
...
<div class="invalid-feedback">Please valid mobile number.</div>
</div>
</div>
...
?>
<div style="color:red" align="center">Your Calculations is Empty</div>
<?php 
}
?>
</div>
